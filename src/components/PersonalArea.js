  ...
  return (
    <div className=' container d-md-block d-lg-flex align-items-start p-0 m-0 '>
      <div style={{width:"300px",display:'flex',flexWrap:'wrap'}} className='myMenu p-0 m-0 '>
          <button  className=" myMenu shadow-lg mybtn text-white font-bold py-2 px-4  w-100 mt-20  h-10 " onClick={() => {
          ...
          <button className="myMenu mybtn shadow-lg text-white font-bold py-2 px-4  w-100 mt-20  h-10" onClick={() => {
          ...
          <button className="  myMenu shadow-lg  mybtn text-white font-bold py-2 px-4 mt-20  w-100  h-10" onClick={() => {
