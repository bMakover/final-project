...
const SearchDrive = () => {
  ...
  return (
    ...
    {sourceInput && (
      <>
        {/* Ask the user for source input */}
        <TypingEffect text="From where do you want?" />
        {/* Render the GoogleMaps component for source */}
        <Demo onInput={handleSourceSelect} />
        <Button variant="outlined" onClick={() => setSourceInput(false)}>
          OK
        </Button>
      </>
    )}
    ...
    {destinationInput && (
      <>
        {/* Ask the user for destination input */}
        <TypingEffect text="To where do you want?" />
        {/* Render the GoogleMaps component for destination */}
        <Demo onInput={handleDestinationSelect} />
        <Button variant="outlined" onClick={findDrives}>
        Search Available Drives
      </Button>
      </>
    )}

    {/* Display the "Search Available Drives" button */}
